...
describe('layout', () => {
    ...
    it('should update budgets if updateBudgets option is true', () => {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = runner.runSchematic('add-layout', Object.assign({}, options, { updateBudgets: true }), appTree);
        const angularContent = JSON.parse(tree.readContent('/angular.json'));
    ...
    it('should consider the `project` option', () => {
        appTree = schematicRunner.runSchematic('application', Object.assign({}, appOptions, { name: 'testApp2', projectRoot: 'projects/testApp2' }), appTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = runner.runSchematic('add-layout', Object.assign({}, options, { project: 'testApp2' }), appTree);
        expect(tree.files)
            .toContain('/devextreme.json');
        expect(tree.files)
    ...
    it('should merge build commands in devextreme.json file', () => {
        appTree = schematicRunner.runSchematic('application', Object.assign({}, appOptions, { name: 'testApp2', prefix: 'app2', projectRoot: 'projects/testApp2' }), appTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        let tree = runner.runSchematic('add-layout', options, appTree);
        tree = runner.runSchematic('add-layout', Object.assign({}, options, { project: 'testApp2' }), appTree);
